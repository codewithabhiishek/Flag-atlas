// Supported image transform hosts (Wix Media CDN)
const MEDIA_TRANSFORM_HOSTS = {
...
/** Returns transform metadata only for canonical Wix Media CDN URLs. */
export function parseWixMediaUrl(src) {
  try {
    ...
    const pathPrefix = MEDIA_TRANSFORM_HOSTS[url.hostname];
